        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                */
                ...
                SmtpClient SmtpServer = new SmtpClient("mail.nok.com.sg");

                mail.From = new MailAddress("TMSystem@nok.com.sg", "TMSystem");
                mail.To.Add(Input.Email.ToString());
                mail.Subject = "Reset Task System PassWord";
